        ...
        <div className="bg-emerald-900/60 border border-emerald-800/50 rounded-2xl p-8 shadow-luxury">
          ...
          <div className="space-y-3 mb-6">
            <button onClick={handleGoogleSignIn}
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-emerald-700/50 bg-emerald-800/40 px-4 py-3 text-sm font-medium text-cream-50 hover:border-gold-400 transition-colors">
            ...
            <button disabled className="w-full flex items-center justify-center gap-3 rounded-lg border border-emerald-800/30 bg-emerald-900/30 px-4 py-3 text-sm font-medium text-cream-100/30 cursor-not-allowed">
              ...
              LinkedIn <span className="text-[10px] uppercase tracking-wider bg-emerald-800/50 px-1.5 py-0.5 rounded ml-auto">Soon</span>
            </button>
            ...
            <button disabled className="w-full flex items-center justify-center gap-3 rounded-lg border border-emerald-800/30 bg-emerald-900/30 px-4 py-3 text-sm font-medium text-cream-100/30 cursor-not-allowed">
              ...
              GitHub <span className="text-[10px] uppercase tracking-wider bg-emerald-800/50 px-1.5 py-0.5 rounded ml-auto">Soon</span>
            </button>
          </div>
